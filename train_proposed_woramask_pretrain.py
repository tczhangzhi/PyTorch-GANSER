...
# CUDA_VISIBLE_DEVICES=3 python train_proposed_woramask_pretrain.py
...
TRAIL_ID = 'cross_validation_proposed_woramask_pretrain'
...
class Trainer():
    ...
    def training_step_g_model(self, batch, batch_idx):
    ...
    def training_step_d_model(self, batch, batch_idx):
